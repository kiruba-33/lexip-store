...
export default function AboutHero() {
  return (
    <section className="bg-slate-950 rounded-3xl p-8 md:p-10 lg:p-20 relative overflow-hidden flex flex-col justify-center min-h-[300px] md:min-h-[400px]">
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_top_right,_var(--tw-gradient-stops))] from-lexip-900/20 via-slate-900/50 to-slate-950" />
      
      <div className="relative z-10 max-w-3xl">
        <span className="block text-xs font-bold text-lexip-400 uppercase tracking-widest mb-4">ABOUT LEXIP</span>
